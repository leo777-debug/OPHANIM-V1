...
To import custom intelligence data use this schema:

```
id, type, lat, lng, label, intensity, details
```


MIT — Built for intelligence research and OSINT demonstration purposes only.

---

> *"OPHANIM-V1 SYSTEM INITIALIZED — STREAMS ACTIVE"*
